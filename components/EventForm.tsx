      ...
      >
        ...
        <div className="space-y-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="font-semibold">Event Name</FormLabel>
                <FormControl>
                  <Input {...field} />
                </FormControl>
                <FormMessage />
                ...
                <FormItem className="flex-1">
                  ...
                  <FormControl>
                    <div className="relative">
                      <span className="font-semibold absolute left-2 top-1/2 -translate-y-1/2">
                        $
                      </span>
                      <Input
                        type="number"
              ...
              {imagePreview || (!removedCurrentImage && currentImageUrl) ? (
                <div className="relative w-32 aspect-square bg-gray-100 rounded-lg">
                  ...
                  <button
                    ...
                    className="absolute -top-2 -right-2 bg-blue-500 text-black rounded-full w-5 h-5 text-xl flex items-center justify-center transition-colors"
                  >
                    ×
                  </button>
                </div>
        ...
        <Button
          type="submit"
          disabled={isPending}
          className="w-full bg-gradient-to-r from-pink-400 to-yellow-500 hover:bg-gradient-to-r hover:from-pink-500 hover:to-yellow-400 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2"
        >
          {isPending ? (
            <>
