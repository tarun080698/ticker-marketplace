          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <button className="flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-100">
                ...
                {/* TODO: This button will save a pdf of the ticket on the device with all the rquired details in a specific print layout */}
              </button>
              <button className="flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-100">
                <Share2 className="w-4 h-4" />
                <span className="text-sm">Share</span>
                {/* TODO: This button will share the ticket as a pdf or image or a event card generator to get embedded on linkedin, facebook like that for example the react event card i have on my linkedin*/}
              </button>
            </div>
          </div>
        ...
        >
          ...
          >
            {ticket.event.is_cancelled
              ...
              : "If you have any issues with your ticket, please contact our support team at team@bookit.com"}
          </p>
        </div>
      </div>
    </div>
